...
export class ListaAcompanhamentosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.cols = [
      ...
      { field: 'cliente', header: 'Cliente', width: '150px', type: '' },
      { field: 'vara', header: 'Varas', width: '80px', type: '' },
      { field: 'numerProcesso', header: 'NumeroProcesso', width: '80px', type: 'text' },
      { field: 'data', header: 'Data', width: '80px', type: 'date' },
      { field: 'informações', header: 'Informações', width: '80px', type: 'text' },
  ...
  onClear() {
    ...
    this.newacompanhamento.cliente = null;
    this.newacompanhamento.vara = null;
    this.newacompanhamento.data = null;
    this.newacompanhamento.numeroProcesso = null;
    this.newacompanhamento.descricao = null;
